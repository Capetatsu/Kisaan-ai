...
const options = [
  { Icon: Phone, title: 'Krishi Helpline', titleHi: 'कृषि हेल्पलाइन', sub: '1800-180-1551', tone: 'bg-primary/12 text-primary' },
  { Icon: MessageCircle, title: 'WhatsApp Support', titleHi: 'व्हाट्सएप सहायता', sub: 'Chat with agent', tone: 'bg-accent/20 text-accent-foreground' },
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {options.map(({ Icon, title, titleHi, sub, tone }) => (
          <GlassCard key={title} className="p-4 animate-fade-up active:scale-[0.97] transition-transform">
